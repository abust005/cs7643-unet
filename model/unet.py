...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=2, padding=0, padding_mode="zeros"):
        ...
        self.module_list = nn.ModuleDict(
            {
                "down_conv_1": DownConv(
                    in_channels, 64, padding=padding, padding_mode=padding_mode
                ),
                "down_conv_2": DownConv(
                    64, 128, padding=padding, padding_mode=padding_mode
                ),
                "down_conv_3": DownConv(
                    128, 256, padding=padding, padding_mode=padding_mode
                ),
                "down_conv_4": DownConv(
                    256, 512, padding=padding, padding_mode=padding_mode
                ),
                "conv_1": ConvBlock(
                    512, 1024, padding=padding, padding_mode=padding_mode
                ),
